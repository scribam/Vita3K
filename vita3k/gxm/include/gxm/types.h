...
enum SceGxmErrorCode : uint32_t {
    ...
    SCE_GXM_ERROR_INVALID_OUTPUT_REGISTER_SIZE = 0x805B001B,
    SCE_GXM_ERROR_INVALID_FRAGMENT_MSAA_MODE = 0x805B001C,
    SCE_GXM_ERROR_INVALID_VISIBILITY_BUFFER_POINTER = 0x805B001D,
    SCE_GXM_ERROR_INVALID_VISIBILITY_INDEX = 0x805B001E,
    SCE_GXM_ERROR_INVALID_DEPTH_STENCIL_CONFIGURATION = 0x805B001F,
    SCE_GXM_ERROR_INVALID_TEXTURE = 0x805B0020,
    SCE_GXM_ERROR_OUT_OF_HOST_MEMORY = 0x805B0021,
    SCE_GXM_ERROR_OUT_OF_BUFFER_MEMORY = 0x805B0022,
    SCE_GXM_ERROR_OUT_OF_VERTEX_USSE_MEMORY = 0x805B0023,
    SCE_GXM_ERROR_OUT_OF_FRAGMENT_USSE_MEMORY = 0x805B0024,
    SCE_GXM_ERROR_INVALID_PRIMITIVE_TYPE = 0x805B0025,
    SCE_GXM_ERROR_INVALID_MAPPING = 0x805B0026,
    SCE_GXM_ERROR_OUT_OF_RENDER_TARGETS = 0x805B0027,
    SCE_GXM_ERROR_INVALID_VISIBILITY_OP = 0x805B0028,
    SCE_GXM_ERROR_RAZOR = 0x805B0029,
    SCE_GXM_ERROR_INVALID_SAMPLER_FILTER_MODE = 0x805B002A,
    SCE_GXM_ERROR_INVALID_REGION_CLIP_IN_COMMAND_LIST = 0x805B002B,
    SCE_GXM_ERROR_WITHIN_COMMAND_LIST = 0x805B002C,
    SCE_GXM_ERROR_NOT_WITHIN_COMMAND_LIST = 0x805B002D,
    SCE_GXM_ERROR_BUFFER_OVERRUN = 0x805B002E
};
